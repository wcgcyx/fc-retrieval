...
func RequestCacheOfferByDigest(adminURL string, adminKey string, digest string, cid string) (
	...
	request, err := fcradminmsg.EncodeCacheOfferByDigestRequest(digest, cid)
	if err != nil {
	...
	respType, respData, err := fcradminserver.Request(adminURL, adminKey, fcradminmsg.CacheOfferByDigestRequestType, request)
	if err != nil {
