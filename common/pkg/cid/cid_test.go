...
func TestGetHashID(t *testing.T) {
	...
	assert.Empty(t, err)
	assert.Equal(t, [32]byte{0xd8, 0x58, 0x99, 0xbc, 0x6b, 0x64, 0xf0, 0x9d,
		0x68, 0xfd, 0x7b, 0x8d, 0xf, 0xce, 0xa3, 0xc, 0x42, 0xb7,
		0x56, 0x25, 0xe, 0xf8, 0x9f, 0x2c, 0xb1, 0x2d, 0x3, 0xf9,
		0x7, 0xba, 0xac, 0xd7}, res)
}
